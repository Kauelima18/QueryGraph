 ...
 * This file demonstrates how to integrate Querygraphthe with a web frontend
 */

// For React/Vue/Angular applications
export class QuerygraphtheClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuerygraphtheClient(provider, contractAddress);
